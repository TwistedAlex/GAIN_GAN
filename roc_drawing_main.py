...
def output_multiple_roc(stats_path_list, title_list, lim_offset, save_dir, mode=False):
    ...
    for i in range(len(stats_path_list)):
        ...
        plt.savefig(os.path.join(save_dir,
                                 file_suffix + datetime.now().strftime('%Y-%m-%d_%H-%M-%S') + ".png"))
        plt.cla()
...
psi_1_list = ["E:\\ResearchData\\heatmap_output\\1k_psi_1\\",
              ...
              "E:\\ResearchData\\heatmap_output\\ex_1k_1k_psi_1\\"]
...
psi_05_list = ["E:\\ResearchData\\heatmap_output\\2k_mixed_psi_05\\",
               ...
               "E:\\ResearchData\\heatmap_output\\ex_1k_2k_mixed_psi_05\\"]

title_list = ["no_ex_AUC",
              "with_500_ex_AUC",
              "with_1.5_exweight_500_ex_AUC",
              "with_1k_ex_AUC"]
save_dir = "E:\\ResearchData\\heatmap_output\\"

output_multiple_roc(psi_1_list, title_list, lim_offset=0.1, save_dir=save_dir, mode=True)
output_multiple_roc(psi_05_list, title_list, lim_offset=0, save_dir=save_dir)
